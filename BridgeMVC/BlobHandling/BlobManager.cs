    ...
    public class BlobManager
    {
        ...
        public BlobManager(string ContainerName)
        {
            ...
            try
            {
                ...
                string ConnectionString = "DefaultEndpointsProtocol=https;AccountName=bridgeblob;AccountKey=ghf+eqxFDNjZWYyszaYeZ60Il3ix4RoQ7tdXVxYLUCXEWcnofY1mwauoxxGAeOVwU7gubqhdvrakgK6s5BgJbA==;EndpointSuffix=core.windows.net";
        ...
        public string UploadFile(HttpPostedFileBase FileToUpload)
        {
            ...
            try
            {
                ...
                // Create a block blob ~/App_Data/WordDoc/Output/PersonInfo.docx
